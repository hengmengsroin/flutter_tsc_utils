...
/// Backward-compatible alias for [TscGenerator].
typedef Generator = TscGenerator;

/// Fluent builder for TSPL/TSPL2 printer commands.
class TscGenerator {
  /// Creates a generator with configurable line ending and text codec.
  TscGenerator({this.newLine = '\r\n', this.codec = latin1})
    : _commands = TscCommandBuffer(codec: codec, newLine: newLine);

  /// New-line sequence appended to each text command.
  final String newLine;

  /// Text encoding used when serializing command strings.
  ...
  /// Builds and returns the raw command bytes.
  Uint8List build() => _commands.build();

  /// Alias for [build].
  List<int> bytes() => build();

  /// Returns a text preview of the generated bytes.
  String preview() => String.fromCharCodes(build());

  /// Appends binary data as-is to the output stream.
  TscGenerator rawBytes(List<int> bytes) {
    _commands.addRawBytes(bytes);
    return this;
  }

  /// Appends a raw command line.
  ...
  /// Configures black mark sensing (continuous form).
  ...
  /// Sets the vertical print offset.
  ...
  /// Lists files in printer memory.
  TscGenerator files() => rawCommand('FILES');

  /// Starts a BASIC program download.
  ...
  /// Downloads binary data into printer memory.
  ...
  /// Downloads text data using configured [codec].
  ...
  /// Marks end of program download.
  TscGenerator eop() => rawCommand('EOP');

  /// Deletes a file from printer memory.
  ...
  /// Moves or renames a file in printer memory.
  TscGenerator move(
  ...
  /// Draws multi-line block text inside a region.
  TscGenerator block(
    int x,
    int y,
    int width,
  ...
  /// Clears an area in the image buffer.
  ...
  /// Inverts pixels in a rectangular area.
  ...
  /// Fits and draws an image into [rect].
  ...
  /// Renders Flutter text to bitmap, then draws it.
